...
1. How do you add an info icon in the pin annoation
2. How can we make it go to different locations other than SF

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='photoMap1.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Copyright 2018 Regie Daquioag and Nicole NicoleHipolito
